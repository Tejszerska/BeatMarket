...
class SongifyCrudFacadeConfiguration {
    ...
    public static SongifyCrudFacade createSongifyCrud(final SongRepository songRepository,
        ...
        SongUpdater songUpdater = new SongUpdater(songRetriever, genreRetriever);
        ...
        ArtistAdder artistAdder = new ArtistAdder(artistRepository,albumAdder, songAdder, albumRetriever);
