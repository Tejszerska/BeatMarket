package com.spring.songify.infrastructure.controller.crud.controller.genre;

import com.spring.songify.domain.crud.dto.GenreDto;
import com.spring.songify.domain.crud.dto.GenreRequestDto;
import com.spring.songify.infrastructure.controller.crud.controller.genre.dto.request.CreateGenreRequest;
import com.spring.songify.infrastructure.controller.crud.controller.genre.dto.response.CreateGenreResponse;
import com.spring.songify.infrastructure.controller.crud.controller.genre.dto.response.GenreResponseDto;
import com.spring.songify.infrastructure.controller.crud.controller.genre.dto.response.GetAllGenresResponseDto;
import com.spring.songify.infrastructure.controller.crud.controller.genre.dto.response.GetGenreResponseDto;
