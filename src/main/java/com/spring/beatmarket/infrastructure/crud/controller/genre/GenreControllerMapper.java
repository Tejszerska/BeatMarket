package com.spring.beatmarket.infrastructure.crud.controller.genre;

import com.spring.beatmarket.domain.crud.dto.GenreDto;
import com.spring.beatmarket.domain.crud.dto.GenreRequestDto;
import com.spring.beatmarket.infrastructure.crud.controller.genre.dto.request.CreateGenreRequest;
import com.spring.beatmarket.infrastructure.crud.controller.genre.dto.response.CreateGenreResponse;
import com.spring.beatmarket.infrastructure.crud.controller.genre.dto.response.GenreResponseDto;
import com.spring.beatmarket.infrastructure.crud.controller.genre.dto.response.GetAllGenresResponseDto;
import com.spring.beatmarket.infrastructure.crud.controller.genre.dto.response.GetGenreResponseDto;
