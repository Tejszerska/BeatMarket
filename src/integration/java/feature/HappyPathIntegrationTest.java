...
import com.spring.beatmarket.BeatMarketApplication;
...
@SpringBootTest(classes = BeatMarketApplication.class)
@Testcontainers
...
class HappyPathIntegrationTest {
    ...
    public void happyPathTest() throws Exception {
        ...
        // 1A. when I go to /songs without jwt then I can see no songs with status isOk
